...
import { ChevronRight, ArrowUp, MapPin, Mail, Phone } from "lucide-react";
    ...
    <section ref={ref} className="py-20 lg:py-28" data-testid="section-fab-cta">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 text-sm text-foreground/60 mt-8">
          ...
          <a href="tel:+16892124722" className="flex items-center gap-2 hover:text-foreground/80 transition-colors" data-testid="link-fab-cta-phone">
            <Phone className="w-4 h-4 text-amber-500 shrink-0" />
            <span><strong className="text-foreground">Phone:</strong> +1 (689) 212-4722</span>
          </a>
          <a href="https://www.facebook.com/procutcoat" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2 hover:text-foreground/80 transition-colors" data-testid="link-fab-cta-facebook">
